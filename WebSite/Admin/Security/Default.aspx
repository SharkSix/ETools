            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="users">
                    <asp:ListView ID="UserListView" runat="server"
                         ...
                         ItemType="eTools.Application.Security.UserProfile"
                    ...
                    <asp:ObjectDataSource ID="UserProfileDataSource" runat="server" DataObjectTypeName="eTools.Application.Security.UserProfile" DeleteMethod="RemoveUser" InsertMethod="AddUser" OldValuesParameterFormatString="original_{0}" SelectMethod="ListAllUsers" TypeName="eTools.Application.Security.UserManager"></asp:ObjectDataSource>
                </div>
                <div class="tab-pane fade" id="roles">
                    <asp:ListView ID="RoleListView" runat="server" DataSourceID="RoleDataSource" 
                         ...
                         ItemType="eTools.Application.Security.RoleProfile"
                         OnItemDeleted="RefreshAll" OnItemInserted="RefreshAll">
                        <EmptyDataTemplate>
                    ...
                    <asp:ObjectDataSource runat="server" ID="RoleDataSource" DataObjectTypeName="eTools.Application.Security.RoleProfile" DeleteMethod="RemoveRole" InsertMethod="AddRole" OldValuesParameterFormatString="original_{0}" SelectMethod="ListAllRoles" TypeName="eTools.Application.Security.RoleManager"></asp:ObjectDataSource>
                </div>
                <div class="tab-pane fade" id="unregistered">
                    <asp:GridView ID="UnregisteredUsersGridView" runat="server" 
                         ...
                         ItemType="eTools.Application.Security.UnregisteredUser" 
                    ...
                    <asp:ObjectDataSource runat="server" ID="UnregisteredUserDataSource" OldValuesParameterFormatString="original_{0}" SelectMethod="ListAllUnregsiteredUsers" TypeName="eTools.Application.Security.UserManager"></asp:ObjectDataSource>
                </div>
            </div>
        </div>
    </div>
