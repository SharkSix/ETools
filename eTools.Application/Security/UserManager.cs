...
using static eTools.Application.Security.UnregisteredUser;
...
namespace eTools.Application.Security
{
    ...
    public class UserManager : UserManager<ApplicationUser>
    {
        ...
        public void RegisterUser(UnregisteredUser userInfo)
        {
            ...
            {
                case UnregisteredUserType.Employee:
                    this.AddToRole(userAccount.Id, SecurityRoles.Employees);
                    break;
                case UnregisteredUserType.Customer:
                    this.AddToRole(userAccount.Id, SecurityRoles.Customers);
                    break;
            }
        }
        ...
        public List<UnregisteredUser> ListAllUnregsiteredUsers()
        {
            using (var context = new eToolsContext())
            {
                ...
                var onlineCustomers = from cust in context.OnlineCustomers
                                where !registeredOnlineCustomers.Any(c => cust.OnlineCustomerID.ToString() == c)
                                select new UnregisteredUser()
                                {
                                    Id = cust.OnlineCustomerID.ToString(),
                ...
                return employees.Union(onlineCustomers).ToList();
            }
        }
